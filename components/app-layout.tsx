  ...
  return (
    <div className="bg-background text-foreground min-h-screen relative overflow-hidden">
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 w-96 h-96 bg-success/5 rounded-full blur-3xl animate-pulse-glow" style={{ animationDelay: '2s' }}></div>
      </div>
      
      <Sidebar />
      <Header />
      <main className="ml-60 mt-16 p-6 relative z-10">
        {children}
      </main>
    </div>
  )
